...
describe('droppable directive', () => {
  ...
  it('should fire the drag enter, over and leave events', () => {
    ...
    expect(fixture.componentInstance.dragEvent).not.to.have.been.called;
    triggerDomEvent('mousemove', draggableElement, {clientX: 5, clientY: 120});
    ...
    triggerDomEvent('mousemove', draggableElement, {clientX: 5, clientY: 125});
    expect(fixture.componentInstance.dragEvent.getCall(2).args).to.deep.equal(['over', {dropData: {foo: 'bar'}}]);
    triggerDomEvent('mousemove', draggableElement, {clientX: 5, clientY: 50});
    expect(fixture.componentInstance.dragEvent.getCall(3).args).to.deep.equal(['leave', {dropData: {foo: 'bar'}}]);
  });
